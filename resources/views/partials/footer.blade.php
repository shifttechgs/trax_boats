                    ...
                    <div class="widget widget_text">
                        ...
                        <div class="pbmit-timelist-wrapper">
                            <ul class="pbmit-timelist-list">
                                <li>
                                    <span class="pbmit-timelist-time">Mon - Fri: 8.00am - 5.00pm</span>
                                </li>
                                <li>
                                    <span class="pbmit-timelist-time">Saturday: 8.00am - 1.00pm</span>
                                </li>
                                <li>
    ...
    <div class="pbmit-footer-text-area">
        <div class="container">
            <div class="pbmit-footer-text-inner">
                <div class="row">
                    <div class="col-md-12">
                        <div class="pbmit-footer-copyright-text-area"> Copyright © <script>document.write(new Date().getFullYear())</script> <a href="#">Trax Boats & Trailers</a>, All Rights Reserved. <a href="https://shifttechgs.com/">Powered By ShiftTech</a></div>
                    </div>
                </div>
            </div>
        </div>
